        ...
        <>
            <ContextMenu>
                        ...
                        <CardContent className="p-0 flex flex-col">
                            ...
                            <div className="p-3 md:p-4 flex flex-col lg:grid lg:grid-cols-12 gap-3 lg:gap-4 items-center">
                                ...
                                <div className="w-full lg:col-span-2 flex flex-col items-start justify-center lg:border-r border-border/10">
                                    <h3 className="font-bold text-base md:text-lg text-foreground leading-tight">{GENERATOR_NAMES[generator.id]}</h3>
                                    <span className="text-xs text-muted-foreground uppercase tracking-wider">Generator</span>
                                </div>
                                ...
                                <div className="w-full lg:col-span-1 flex flex-col items-center justify-center lg:border-r border-border/10">
                                    <Badge variant="secondary" className="text-xs px-1.5 md:px-2 py-0 h-5 md:h-6 bg-primary/10 text-primary border-primary/20 pointer-events-none mb-1">
                                        Rank {level}
                                    </Badge>
                                ...
                                <div className="w-full lg:col-span-1 flex flex-col items-center justify-center">
                                    <span className="text-foreground font-mono font-bold text-xs">{formatNumber(generator.amount)}</span>
                                        ...
                                        <Tooltip delayDuration={200}>
                                            <TooltipTrigger asChild>
                                                <div className="flex flex-col items-center cursor-help group">
                                                    <div className="text-xs font-medium text-foreground flex flex-wrap gap-1 justify-center group-hover:text-primary transition-colors">
                                                        <span>{formatNumber(productionPerSecond)}</span>
                                                        <span className="text-muted-foreground">/s</span>
                                                        <span className="text-primary/80 text-xs ml-1">
                                                            {generator.id === 0 ? "Eternity Fragments" : GENERATOR_NAMES[generator.id - 1]}
                                                        </span>
                                                    </div>
                                                    <span className="text-xs text-muted-foreground uppercase tracking-wider group-hover:text-foreground/80 transition-colors">Production</span>
                                                </div>
                                            </TooltipTrigger>
                                            <TooltipContent side="bottom" className="p-4 bg-popover/95 backdrop-blur-sm border-primary/20 shadow-xl">
                                                <div className="flex flex-col gap-2 min-w-[180px]">
                                                    <div className="flex flex-col gap-0.5 pb-2 border-b border-border/50">
                                                        ...
                                                        <span className="text-[10px] text-muted-foreground">Detailed calculation for {GENERATOR_NAMES[generator.id]}</span>
                                                    </div>
                                ...
                                <div className="w-full lg:col-span-2 flex flex-col items-center justify-center">
                                    <span className="font-mono text-foreground/80 text-xs whitespace-nowrap">
                                    ...
                                    <div className="text-xs text-muted-foreground uppercase tracking-wider flex items-center gap-1 justify-center whitespace-nowrap">
                                ...
                                <div className="w-full lg:col-span-3 flex items-center justify-center lg:justify-end gap-2">
                                        ...
                                        <Tooltip delayDuration={200}>
                                            <TooltipTrigger asChild>
                                                <Button
                                                    ...
                                                    className={`h-14 transition-all duration-300 relative ${isActive ? 'w-32 gap-2 bg-red-500/20 text-red-500 border-red-500/50 shadow-[0_0_15px_rgba(239,68,68,0.3)]' : 'w-14 bg-muted/10 text-muted-foreground border-zinc-800 hover:border-zinc-700 hover:text-foreground'}`}
                                                >
                                            ...
                                            <TooltipContent side="top" sideOffset={4} className="bg-popover/95 backdrop-blur-sm border-primary/20 shadow-xl p-3 z-[150]">
                                    ...
                                    <Button
                                        ...
                                        className={`flex-1 min-w-[120px] max-w-[180px] h-14 flex flex-row lg:flex-col items-center justify-center gap-1 lg:gap-0 ${!canAfford && "opacity-50"}`}
                                    >
                                ...
                                <div className="flex flex-col w-full">
                                    ...
                                    <div className="px-4 py-1.5 flex flex-wrap gap-2 bg-muted/20">
                                        {research[`gen${generator.id + 1}_speed`] > 0 && (
                                            <Badge variant="outline" className="text-xs h-6 bg-purple-500/5 text-purple-400 border-purple-500/20 pointer-events-none">
                ...
                <ContextMenuContent className="w-56 bg-zinc-950 border-zinc-800 text-zinc-100 shadow-2xl">
                    <div className="px-2 py-2 text-xs uppercase font-black text-zinc-500 tracking-widest border-b border-zinc-900 mb-1">
                        {GENERATOR_NAMES[generator.id]}
                    </div>
                    <ContextMenuItem
